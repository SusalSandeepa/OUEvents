    ...
    <div className="flex w-full h-full bg-primary">
      ...
      {step == "email" && (
        <div className="w-[50%] h-full flex justify-center items-center">
          <div className="w-[500px] bg-[#fdfbf9] shadow-2xl rounded-3xl py-10">
            ...
            <div className="text-secondary ml-[50px] mt-8 text-sm font-medium">
              Email Address
            </div>
            ...
            <div className="flex justify-center mt-8">
              <button
                onClick={sendOTP}
                className="w-[400px] h-[40px] bg-accent/95 flex items-center border border-gray-300 justify-center text-white font-medium rounded-lg hover:bg-accent transition-colors"
              >
      ...
      {step == "otp" && (
        <div className="w-[50%] h-full flex justify-center items-center">
          <div className="w-[500px] bg-[#fdfbf9] shadow-2xl rounded-3xl py-10">
            ...
            <div className="text-secondary ml-[50px] mt-6 text-sm font-medium">
            ...
            <div className="flex-col text-sm">
              <input
                ...
                className="w-[400px] h-[40px] border bg-white border-gray-300 rounded-lg p-2 mt-2 ml-[50px] tracking-widest text-center font-semibold"
              />
            </div>

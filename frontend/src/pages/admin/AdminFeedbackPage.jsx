        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-5">
                    <p className="text-blue-600 text-sm font-medium mb-1">Total Feedback</p>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-5">
                    <p className="text-yellow-600 text-sm font-medium mb-1">Average Rating</p>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-5">
                    <p className="text-green-600 text-sm font-medium mb-1">Events with Feedback</p>
                    <p className="text-3xl font-bold text-green-900">{uniqueEventIds.length}</p>
                </div>
            </div>
